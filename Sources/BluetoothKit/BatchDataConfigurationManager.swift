...
public class BatchDataConfigurationManager {
    ...
    // MARK: - Properties (UI 프레임워크 의존성 제거)
    ...
    private var _isMonitoringActive = false  // 설정 완료 → 모니터링 활성화로 변경
    ...
    private var _pendingSensorSelection: Set<SensorType>?  // 하위 호환성을 위해 유지
